...
class Test_MessageEdit_Immediate_Live_Create():
    ...
    @pytest.mark.parametrize('campaignType,testControlType,listType,channel,messageInfo,editInfo', [
        ('LIVE', 'ORG', 'UPLOAD', 'MOBILE',
         ...
         {'schedule':{'scheduleType': 'PARTICULAR_DATE', 'scheduledDate': int(time.time() * 1000) + 24 * 60 * 60 * 1000}})
    ])
    def irisv2_message_edit_immediate_live_create_plain_mobile_schedulle_body_Sanity(self, campaignType, testControlType, listType,
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_targetAudience_Sanity_body(self, campaignType,
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_schedulle_body(self, campaignType,
                                                                                          testControlType, listType,
                                                                                          channel, messageInfo,
                                                                                          editInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
    ...
    def irisv2_message_edit_immediate_live_create_plain_email_schedulle_body_Sanity(self, campaignType,
                                                                                          testControlType, listType,
                                                                                          channel, messageInfo,
                                                                                          editInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
    ...
    def irisv2_message_edit_immediate_live_create_plain_email_schedulle_body(self, campaignType,
                                                                                         testControlType, listType,
                                                                                         channel, messageInfo,
                                                                                         editInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobilePush_schedulle_body_Sanity(self, campaignType,
                                                                                         testControlType, listType,
                                                                                         channel, messageInfo,
                                                                                         editInfo):
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobilePush_schedulle_body(self, campaignType,
                                                                                  testControlType, listType,
                                                                                  channel, messageInfo,
                                                                                  editInfo):
        actualOrgId = IrisHelper.updateOrgId(constant.config['mobilepush']['orgId'])
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_targetAudience_body(self, campaignType,
                                                                                          testControlType, listType,
                                                                                          channel, messageInfo):
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_additionalSettings_body(self, campaignType,
                                                                                               testControlType,
                                                                                               listType,
                                                                                               channel, messageInfo,
                                                                                               keys):
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_channleSetting_body(self, campaignType, testControlType, listType,
                                                                        channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
        CreateMessage.assertResponse(messageDetails['RESPONSE'], 200)
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_storeType_body(self, campaignType,
                                                                                        testControlType, listType,
                                                                                        channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_messageBody_body(self, campaignType,
                                                                                   testControlType, listType,
                                                                                   channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_channel_body(self, campaignType,
                                                                                     testControlType, listType,
                                                                                     channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_sms_to_mobilePush_body(self, campaignType,
                                                                                 testControlType, listType,
                                                                                 channel, messageInfo):
        actualOrgId = IrisHelper.updateOrgId(constant.config['mobilepush']['orgId'])
        try:
            ...
            messageDetails['PAYLOAD']['deliverySetting'] = CreateMessage.constructDeliverySetting(['MOBILE_PUSH'],
                                                                            ...
                                                                            maxUsers=[])
            editInfo = CreateMessage.edit(campaignInfo['ID'],messageDetails['RESPONSE']['json']['entity']['id'], messageDetails['PAYLOAD'])
            CreateMessageDBAssertion(campaignInfo['ID'],editInfo['RESPONSE']['json']['entity']['id'], editInfo['PAYLOAD'],version=1).check()
        finally:
            IrisHelper.updateOrgId(actualOrgId)
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_coupon_sms_to_mobilePush_body(self, campaignType,
                                                                                           testControlType, listType,
                                                                                           channel, messageInfo):
        actualOrgId = IrisHelper.updateOrgId(constant.config['mobilepush']['orgId'])
        try:
            ...
            messageDetails['PAYLOAD']['messageContent'] = CreateMessage.constructMessageContent(campaignType,
                                                                                                ...
                                                                                                storeType='REGISTERED_STORE',
                                                                                                numberOfCustomTag=0)
            messageDetails['PAYLOAD']['messageContent']['message_content_id_1']['offers'][0]['couponSeriesId']=couponSeriesId
            messageDetails['PAYLOAD']['deliverySetting'] = CreateMessage.constructDeliverySetting(['MOBILE_PUSH'],
                                                                                                  messageInfo[
                                                                                                      'useTinyUrl'],
                                                                                                  messageInfo[
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_plain_points_message_to_couponMessage(self, campaignType,
                                                                                          testControlType, listType,
                                                                                          channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_plain_coupon_message_to_pointsMessage(self,
                                                                                                          campaignType,
                                                                                                          testControlType,
                                                                                                          listType,
                                                                                                          channel,
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_points_coupon_message_to_plainMessage(self,
                                                                                                          campaignType,
                                                                                                          testControlType,
                                                                                                          listType,
                                                                                                          channel,
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_editMessage_withouChanging_body(self, campaignType,
                                                                                        testControlType, listType,
                                                                                        channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_editMessage_multipleTimes_body(self, campaignType,
                                                                                                   testControlType,
                                                                                                   listType,
                                                                                                   channel,
                                                                                                   messageInfo):
    ...
    @pytest.mark.parametrize('campaignType,testControlType,channel,messageInfo,editInfo', [
        ('LIVE', 'ORG', 'MOBILE',
         {'scheduleType': {'type': 'IMMEDIATE'}, 'offerType': 'PLAIN', 'messageStrategy': {'type': 'DEFAULT'},
          'channels': ['SMS', 'EMAIL'], 'useTinyUrl': False, 'encryptUrl': False, 'skipRateLimit': True},
         {'schedule':{'scheduleType': 'PARTICULAR_DATE', 'scheduledDate': int(time.time() * 1000) + 24 * 60 * 60 * 1000}}),
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_editStickyListMessage(self, campaignType, testControlType,
                                                                     channel, messageInfo, editInfo):
    ...
    def irisv2_message_edit_immediate_live_create_plain_mobile_editStickyListMessage_targetAudience(self, campaignType,
                                                                                        testControlType,
                                                                                        channel, messageInfo):
