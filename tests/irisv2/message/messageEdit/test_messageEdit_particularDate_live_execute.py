...
class Test_MessageEdit_ParticularDate_Live_Execute():
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_schedulle_body_Sanity(self, campaignType, testControlType, listType,
    ...
    def irisv2_message_edit_particularDate_live_execute_otherCase_plain_mobile_schedulle_body(self, campaignType,
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_schedulle_recurring_plain_body(self,
                                                                                                         campaignType,
                                                                                                         testControlType,
                                                                                                         listType,
                                                                                                         channel,
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_schedulle_recurring_coupon_body(self,
                                                                                                          campaignType,
                                                                                                          testControlType,
                                                                                                          listType,
                                                                                                          channel,
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_schedulle_recurring_points_body(self,
                                                                                                          campaignType,
                                                                                                          testControlType,
                                                                                                          listType,
                                                                                                          channel,
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_email_schedulle_body_Sanity(self, campaignType,
                                                                                         testControlType, listType,
                                                                                         channel, messageInfo,
                                                                                         editInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_email_schedulle_body(self, campaignType,
                                                                                  testControlType, listType,
                                                                                  channel, messageInfo,
                                                                                  editInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_email_schedulle_recurring_plain_body(self, campaignType,
                                                                                    testControlType, listType,
                                                                                    channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_email_schedulle_recurring_coupon_body(self, campaignType,
                                                                                                    testControlType,
                                                                                                    listType,
                                                                                                    channel,
                                                                                                    messageInfo):
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_email_schedulle_recurring_points_body(self, campaignType,
                                                                                                     testControlType,
                                                                                                     listType,
                                                                                                     channel,
                                                                                                     messageInfo):
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobilePush_schedulle_body_Sanity(self, campaignType,
                                                                                              testControlType, listType,
                                                                                              channel, messageInfo,
                                                                                              editInfo):
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_targetAudience_body(self, campaignType,
                                                                                        testControlType, listType,
                                                                                        channel, messageInfo):
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_additionalSettings_body(self, campaignType,
                                                                                            testControlType,
                                                                                            listType,
                                                                                            channel, messageInfo,
                                                                                            keys):
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_channleSetting_body(self, campaignType,
                                                                                        testControlType, listType,
                                                                                        channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_storeType_body(self, campaignType,
                                                                                   testControlType, listType,
                                                                                   channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_messageBody_body(self, campaignType,
                                                                                   testControlType, listType,
                                                                                   channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_channel_body(self, campaignType,
                                                                                     testControlType, listType,
                                                                                     channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_sms_to_mobilePush_body(self, campaignType,
                                                                                 testControlType, listType,
                                                                                 channel, messageInfo):
        actualOrgId = IrisHelper.updateOrgId(constant.config['mobilepush']['orgId'])
        try:
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_coupon_sms_to_mobilePush_body(self, campaignType,
                                                                                                 testControlType,
                                                                                                 listType,
                                                                                                 channel, messageInfo):
        actualOrgId = IrisHelper.updateOrgId(constant.config['mobilepush']['orgId'])
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_plain_points_message_to_couponMessage(self, campaignType,
                                                                                          testControlType, listType,
                                                                                          channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_plain_coupon_message_to_pointsMessage(self,
                                                                                                          campaignType,
                                                                                                          testControlType,
                                                                                                          listType,
                                                                                                          channel,
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_points_coupon_message_to_plainMessage(self,
                                                                                                          campaignType,
                                                                                                          testControlType,
                                                                                                          listType,
                                                                                                          channel,
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_editMessage_withouChanging_body(self, campaignType,
                                                                                        testControlType, listType,
                                                                                        channel, messageInfo):
        messageDetails = CreateMessage.create(campaignType, testControlType, listType, channel, messageInfo,
                                              updateNode=True, lockNode=True)
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_editMessage_multipleTimes_body(self, campaignType,
                                                                                                   testControlType,
                                                                                                   listType,
                                                                                                   channel,
                                                                                                   messageInfo):
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_editMessage_alreadyApproved(self,
                                                                                                         campaignType,
                                                                                                         testControlType,
                                                                                                         listType,
                                                                                                         channel,
    ...
    def irisv2_message_edit_particularDate_live_execute_plain_mobile_editMessage_expireMessageAndEditTime(self,
                                                                                                     campaignType,
                                                                                                     testControlType,
                                                                                                     listType,
                                                                                                     channel,
