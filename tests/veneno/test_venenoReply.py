...
class Test_VenenoReply_ORG():
    ...
    def test_veneno_replyMessage_ORG_Sanity(self, description, couponConfig, skippedReason, configChange):
    ...
    def test_veneno_replyMessage_ORG_allErrorTypes(self, description, changeCouponConfig):
